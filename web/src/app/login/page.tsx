...
export default async function LoginPage({searchParams}:{searchParams:Promise<{changed?:string}>}) {
 ...
 return <main className="grid min-h-screen lg:grid-cols-2">
  {/* Compact brand banner on phone/tablet (fixed height, no mission copy
      pushing the form off-screen); full split-screen brand panel from lg
      up, unchanged. */}
  <section className="flex flex-col justify-between bg-[#152b36] p-5 text-white lg:p-16 lg:min-h-screen">
